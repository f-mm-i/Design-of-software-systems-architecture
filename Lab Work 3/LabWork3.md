...
> Код клиентской и серверной части добавлен в файл "Реализация клиентского и серверного кода". Здесь — пояснение, какие решения приняты, чтобы соответствовать принципам.
