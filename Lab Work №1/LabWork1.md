...
**Проект:** мобильное приложение «Mental Maps» – приложение для рисования ментальных карт города во время путешествий:contentReference[oaicite:0]{index=0}  
...
![Диаграмма вариантов использования приложения «Mental Maps»](Диаграмма вариантов использования.png)
